...
class TestWorkflowContextPersistence(unittest.TestCase):
    def test_save_and_load_roundtrip(self) -> None:
        with tempfile.TemporaryDirectory() as td:
            ...
            ctx.set_transmission_source("config_2", "config_1")
            ...
            self.assertEqual(loaded.get_transmission("sample_a", "config_2"), 0.91)
            self.assertEqual(loaded.get_empty_cell_transmission("config_1"), 0.95)
            self.assertEqual(loaded.get_empty_cell_transmission("config_2"), 0.95)
            self.assertEqual(loaded.get_transmission_source("config_2"), "config_1")
